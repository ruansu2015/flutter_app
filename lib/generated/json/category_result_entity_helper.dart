...
categoryResultEntityFromJson(CategoryResultEntity data, Map<String, dynamic> json) {
	if (json['mallExtendCategory'] != null) {
		data.mallExtendCategory = CategoryResultMallExtendCategory().fromJson(json['mallExtendCategory']);
	}
	if (json['children'] != null) {
		data.children = (json['children'] as List).map((v) => CategoryResultChildren().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> categoryResultEntityToJson(CategoryResultEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['mallExtendCategory'] = entity.mallExtendCategory?.toJson();
	data['children'] =  entity.children?.map((v) => v.toJson())?.toList();
	return data;
}

categoryResultMallExtendCategoryFromJson(CategoryResultMallExtendCategory data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> categoryResultMallExtendCategoryToJson(CategoryResultMallExtendCategory entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
categoryResultChildrenFromJson(CategoryResultChildren data, Map<String, dynamic> json) {
	if (json['mallExtendCategory'] != null) {
		data.mallExtendCategory = CategoryResultChildrenMallExtendCategory().fromJson(json['mallExtendCategory']);
	}
	if (json['children'] != null) {
		data.children = (json['children'] as List).map((v) => CategoryResultChildrenChildren().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> categoryResultChildrenToJson(CategoryResultChildren entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['mallExtendCategory'] = entity.mallExtendCategory?.toJson();
	data['children'] =  entity.children?.map((v) => v.toJson())?.toList();
	return data;
...
categoryResultChildrenMallExtendCategoryFromJson(CategoryResultChildrenMallExtendCategory data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'] is String
				? int.tryParse(json['id'])
				: json['id'].toInt();
...
Map<String, dynamic> categoryResultChildrenMallExtendCategoryToJson(CategoryResultChildrenMallExtendCategory entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['parentId'] = entity.parentId;
	data['siteCateName'] = entity.siteCateName;
...
categoryResultChildrenChildrenFromJson(CategoryResultChildrenChildren data, Map<String, dynamic> json) {
	if (json['mallExtendCategory'] != null) {
		data.mallExtendCategory = CategoryResultChildrenChildrenMallExtendCategory().fromJson(json['mallExtendCategory']);
	}
	return data;
}

Map<String, dynamic> categoryResultChildrenChildrenToJson(CategoryResultChildrenChildren entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['mallExtendCategory'] = entity.mallExtendCategory?.toJson();
	return data;
}

categoryResultChildrenChildrenMallExtendCategoryFromJson(CategoryResultChildrenChildrenMallExtendCategory data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'] is String
				? int.tryParse(json['id'])
				: json['id'].toInt();
...
Map<String, dynamic> categoryResultChildrenChildrenMallExtendCategoryToJson(CategoryResultChildrenChildrenMallExtendCategory entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['parentId'] = entity.parentId;
	data['siteCateName'] = entity.siteCateName;
