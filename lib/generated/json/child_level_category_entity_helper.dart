...
childLevelCategoryEntityFromJson(ChildLevelCategoryEntity data, Map<String, dynamic> json) {
	if (json['mallExtendCategory'] != null) {
		data.mallExtendCategory = ChildLevelCategoryMallExtendCategory().fromJson(json['mallExtendCategory']);
	}
	if (json['children'] != null) {
		data.children = (json['children'] as List).map((v) => ChildLevelCategoryChildren().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> childLevelCategoryEntityToJson(ChildLevelCategoryEntity entity) {
...
childLevelCategoryMallExtendCategoryFromJson(ChildLevelCategoryMallExtendCategory data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> childLevelCategoryMallExtendCategoryToJson(ChildLevelCategoryMallExtendCategory entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
childLevelCategoryChildrenFromJson(ChildLevelCategoryChildren data, Map<String, dynamic> json) {
	if (json['mallExtendCategory'] != null) {
		data.mallExtendCategory = ChildLevelCategoryChildrenMallExtendCategory().fromJson(json['mallExtendCategory']);
	}
	if (json['children'] != null) {
		data.children = (json['children'] as List).map((v) => ChildLevelCategoryChildrenMallExtendCategory().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> childLevelCategoryChildrenToJson(ChildLevelCategoryChildren entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['mallExtendCategory'] = entity.mallExtendCategory?.toJson();
	data['children'] =  entity.children?.map((v) => v.toJson())?.toList();
	return data;
...
childLevelCategoryChildrenMallExtendCategoryFromJson(ChildLevelCategoryChildrenMallExtendCategory data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'] is String
				? int.tryParse(json['id'])
				: json['id'].toInt();
...
Map<String, dynamic> childLevelCategoryChildrenMallExtendCategoryToJson(ChildLevelCategoryChildrenMallExtendCategory entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['parentId'] = entity.parentId;
	data['siteCateName'] = entity.siteCateName;
